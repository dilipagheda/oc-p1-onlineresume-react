    ...
    items: [
        {
            ...
            achievements: [
                "Delivered a Project called Digital Communications Channel (DCC) within Colonial First Estate (CFS) division of Commonwealth Bank.",
        ...
        },        
        {
            ...
            achievements: [
                "Delievered RebatesHub project that will enable everyday Australians to discover rebates that they are eligible for",
                "Delivered API migration project for CommBank Mobile App by automating scenario based APIs (Microservices) testing using Postman/Newman framework with a ton of JavaScript based test code having dynamic assertions.",
                "Developed Automation framework for Web using Behaviour driven development (BDD) approach using SpecFlow, Selenium Webdriver, C# , SQL Server and RestSharp API library. Achieved 100% automation that runs on all major browsers via TeamCity Continuous Integration.",
                ...
                "Built a project that demonstrates use of Node.js & JavaScript for Web and Mobile automation with the intention to migrate C# tests to Node.js in future."
            ],
            skillsGained: [
                "React","Selenium Webdriver", "C#", "Specflow", "RestSharp", "Postman", "JavaScript", "Node.js"
            ]
        },
        {
